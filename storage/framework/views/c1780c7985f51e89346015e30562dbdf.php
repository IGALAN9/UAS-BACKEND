            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="<?php echo e(route('post.store')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <?php echo e(__("Selamat datang di medsos kelompok 2 back end ayeea ayyeeaaa")); ?>
...
<?php endif; ?>
<?php /**PATH D:\SEMESTER 2\BACK END PROGRAMMING\UAS OLD REPO\UAS-BACKEND\resources\views/dashboard.blade.php ENDPATH**/ ?>